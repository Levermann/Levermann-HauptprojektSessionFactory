               ...
               dreimonatsreversalPkt=dreimonatsreversalPkt/ 100;
                ...
                if (dreimonatsreversalPkt > 1.00 == true) {
                    ...
                    for (Levermannschritte lvsch : unList1) {
                        ...
                        if (lvsch.getUnternehmenname_Levermannschritte() == un.getUnternehmenname()  == true &&dreimonatsreversalPkt>= 0.05 == true) {
                            System.out.println("Richtig :D" + lvsch.getUnternehmenname_Levermannschritte() + " = " + un.getUnternehmenname()  + "i = " + dreimonatsreversalPkt);
                            lvsch.setReaktionaufQuartalszahlen((float) 1);
                        }

                        lvsch.setLevermannschrittAnalyseNameId (lvsch.getLevermannschrittAnalyseNameId ());
                         System.out.println("Unternehmen: " + un.getUnternehmenname() + " Levermannschritt: " + lvsch.getUnternehmenname_Levermannschritte()  + "  dreimonatsreversalPkt " + dreimonatsreversalPkt);
                ...
                if (dreimonatsreversalPkt < -1.00 == true) {
                    ...
                    for (Levermannschritte lvsch1 : unList1) {
                        ...
                        if (lvsch1.getUnternehmenname_Levermannschritte() == un.getUnternehmenname()  == true &&dreimonatsreversalPkt<= -0.05 == true) {
                            System.out.println("Richtig :D" + lvsch1.getUnternehmenname_Levermannschritte() + " = " + un.getUnternehmenname()  + "i = " + dreimonatsreversalPkt);
                ...
                if (dreimonatsreversalPkt < -1.00 == false &&dreimonatsreversalPkt> 1.00 == false ) {
                    ...
                    for (Levermannschritte lvsch1 : unList1) {
                        ...
                        if (lvsch1.getUnternehmenname_Levermannschritte() == un.getUnternehmenname()  == true &&dreimonatsreversalPkt> 0.005 == false &&dreimonatsreversalPkt< -0.05 == false) {
                            System.out.println("Richtig :D" + lvsch1.getUnternehmenname_Levermannschritte() + " = " + un.getUnternehmenname()  + "i = " + dreimonatsreversalPkt);
